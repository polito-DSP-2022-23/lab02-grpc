...
app.post('/api/films/public/:filmId/reviews', isLoggedIn, validate({ body: reviewSchema }), reviewController.issueFilmReview);
...
app.post('/api/films/public/assignments', isLoggedIn, reviewController.assignReviewBalanced);
...
app.get('/api/users/:userId/films/private', isLoggedIn, filmController.getPrivateFilms);
...
app.get('/api/films/public/:filmId/images/:imageId/imageFile', isLoggedIn, imageController.getSingleImageFile);
